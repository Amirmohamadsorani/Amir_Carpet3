...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 04, 2025 at 05:24 PM
...
(3, 'یاس', 6400000, 'picture/yas.webp', 'خرید موکت پالاز یاس (Pallas Yash) یکی از مواردی است که در طراحی و دکوراسیون داخلی فضاها بسیار مهم است.'),
(4, 'الماس', 15000000, 'picture/almas.webp', 'موکت الماس، محصولی باکیفیت از شرکت پالاز، به دلیل داشتن ویژگی‌های منحصر به فرد، همچنان یکی از محبوب‌ترین گزینه‌ها برای کف‌پوش منازل به شمار می‌رود'),
